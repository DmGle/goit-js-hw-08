 ...
 */var F=function(e,t,n){var r=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"addEventListener",o=arguments.length>4&&void 0!==arguments[4]?arguments[4]:"removeEventListener",i="string"==typeof t?[t]:t;return i.forEach(function(t){e[r](t,n)}),{cancel:function(){return i.forEach(function(t){return e[o](t,n)})}}},N=void 0!==Array.prototype.indexOf,L="undefined"!=typeof window&&void 0!==window.postMessage;if(!O&&(!N||!L))throw Error("Sorry, the Vimeo Player API is not available in this browser.");var A="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:void 0!==a?a:"undefined"!=typeof self?self:{};!/*!
 ...
 */var $={role:"viewer",autoPlayMuted:!0,allowedDrift:.3,maxAllowedDrift:1,minCheckInterval:.1,maxRateAdjustment:.2,maxTimeToCatchUp:1},B=/*#__PURE__*/function(e){!function(e,t){if("function"!=typeof t&&null!==t)throw TypeError("Super expression must either be null or a function");e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,writable:!0,configurable:!0}}),Object.defineProperty(e,"prototype",{writable:!1}),t&&k(e,t)}(a,e);var t,n,r,o,i=(t=E(),function(){var e,n=w(a);if(t){var r=w(this).constructor;e=Reflect.construct(n,arguments,r)}else e=n.apply(this,arguments);return function(e,t){if(t&&("object"==typeof t||"function"==typeof t))return t;if(void 0!==t)throw TypeError("Derived constructors may only return object or undefined");return P(e)}(this,e)});/**
   ...
   */function a(e,t){var n,r,o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{},u=arguments.length>3?arguments[3]:void 0;return y(this,a),b(P(r=i.call(this)),"logger",void 0),b(P(r),"speedAdjustment",0),/**
     ...
     * @return {Promise<void>}
     */function(e,t){return new Promise(function(n){!function r(){e.readyState===t?n():e.addEventListener("readystatechange",r,{once:!0})}()})}}]),a}(/*#__PURE__*/T(EventTarget)),Q=new WeakMap,J=new WeakMap,X={},K=/*#__PURE__*/function(){var e;/**
   * Create a Player.
   *
...
if(Q.has(e))return Q.get(e);this._window=e.ownerDocument.defaultView,this.element=e,this.origin="*";var a=new R(function(t,n){if(r._onMessage=function(e){if(M(e.origin)&&r.element.contentWindow===e.source){"*"===r.origin&&(r.origin=e.origin);var o=W(e.data);if(o&&"error"===o.event&&o.data&&"ready"===o.data.method){var i=Error(o.data.message);i.name=o.data.name,n(i);return}var a=o&&"ready"===o.event,u=o&&"ping"===o.method;if(a||u){r.element.setAttribute("data-ready","true"),t();return}!/**
...
}})}(r,o)}},r._window.addEventListener("message",r._onMessage),"IFRAME"!==r.element.nodeName){var i=G(e,o);Y(C(i),i,e).then(function(t){var n,o,i=H(t,e);return(// Overwrite element with the new iframe,
// but store reference to the original element
r.element=i,r._originalElement=e,n=e,o=I.get(n),I.set(i,o),I.delete(n),Q.set(r.element,r),t)}).catch(n)}});if(// Store a copy of this Player in the map
J.set(this,a),Q.set(this.element,this),"IFRAME"===this.element.nodeName&&U(this,"ping"),X.isEnabled){var u=function(){return X.exit()};this.fullscreenchangeHandler=function(){X.isFullscreen?q(r,"event:exitFullscreen",u):D(r,"event:exitFullscreen",u),// eslint-disable-next-line
r.ready().then(function(){U(r,"fullscreenchange",X.isFullscreen)})},X.on("fullscreenchange",this.fullscreenchangeHandler)}return this}return(/**
...
if(null!==e.getAttribute("data-vimeo-defer"))return;var t=G(e),r=C(t);Y(r,t,e).then(function(t){return H(t,e)}).catch(n)}catch(e){n(e)}})}(),/**
 ...
 * @return {void}
 */function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:document;//  Prevent execution if users include the player.js script multiple times.
window.VimeoSeoMetadataAppended||(window.VimeoSeoMetadataAppended=!0,window.addEventListener("message",function(t){if(M(t.origin)){var n=W(t.data);if(n&&"ready"===n.event)for(var r=e.querySelectorAll("iframe"),o=0;o<r.length;o++){var i=r[o],a=i.contentWindow===t.source;S(i.src)&&a&&new K(i).callMethod("appendVideoMetadata",window.location.href)}}}))}(),/**
 * Seek to time indicated by vimeo_t query parameter if present in URL
 *
 * @param {HTMLElement} [parent=document] The parent element.
 * @return {void}
 */function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:document;//  Prevent execution if users include the player.js script multiple times.
if(!window.VimeoCheckedUrlTimeParam){window.VimeoCheckedUrlTimeParam=!0;var t=function(e){"console"in window&&console.error&&console.error("There was an error getting video Id: ".concat(e))};window.addEventListener("message",function(n){if(M(n.origin)){var r=W(n.data);if(r&&"ready"===r.event)for(var o=e.querySelectorAll("iframe"),i=0;i<o.length;i++)!function(){var e=o[i],r=e.contentWindow===n.source;if(S(e.src)&&r){var a=new K(e);a.getVideoId().then(function(e){var t=new RegExp("[?&]vimeo_t_".concat(e,"=([^&#]*)")).exec(window.location.href);if(t&&t[1]){var n=decodeURI(t[1]);a.setCurrentTime(n)}}).catch(t)}}()}})}}());const Z="videoplayer-current-time",ee=document.getElementById("vimeo-player"),et=new K(ee);// Ініціалізація плеєра та відстеження події timeupdate
et.ready().then(()=>{// Отримання часу відтворення з локального сховища та відновлення його
let e=localStorage.getItem(Z);e&&et.setCurrentTime(parseFloat(e)),et.on("timeupdate",(s&&s.__esModule?s.default:s)(()=>{// Відстеження події timeupdate та збереження часу в локальному сховищі
let e=et.currentTime;localStorage.setItem(Z,e)},1e3))}),// Під час перезавантаження сторінки методом setCurrentTime() відновлюємо відтворення зі збереженої позиції
window.addEventListener("beforeunload",()=>{et.getCurrentTime().then(e=>{localStorage.setItem(Z,e)})});//# sourceMappingURL=02-video.e161a0d4.js.map

//# sourceMappingURL=02-video.e161a0d4.js.map
